...
public class PoliceStationScenario : MonoBehaviour {
	...
	{
		"You walk into NUPD. ",
		"you see a bunch of police having a nice sausage barbeque party in front of their police building.",
		"A Police Officer talke to you: ",
		"'im gonna have to ask you to leave. This is a crime scene as we spotted a bunch of dead sausage.'",
		"Then you have to leave the police station."
	};
